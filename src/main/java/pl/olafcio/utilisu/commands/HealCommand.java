...
public class HealCommand extends Command {
    @Syntax("/heal")
    @PermissionLevel(value = "utilisu.heal", level = PermissionLevel.Enum.GAMEMASTERS)
    ...
    @Syntax("/heal <player>")
    @PermissionLevel(value = "utilisu.heal.others", level = PermissionLevel.Enum.GAMEMASTERS)
